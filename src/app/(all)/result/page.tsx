...
const ResultPage = async () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center overflow-y-auto py-4">
      <div className="w-1/2 max-w-[750px]">
        <div className="gradient w-full p-4 py-6 rounded-t-md">
          <div className="flex flex-row items-center h-full w-full">
            {/* logo */}
            <div className="size-20 aspect-square flex items-center justify-center  mr-6">
              <svg
            ...
            <div className="flex flex-col text-white w-full">
              <h1 className="font-bold mb-2 text-2xl leading-5">
                XYZ High School,Dhaka,Bangladesh
              </h1>
              <h2 className="text-xl">কখগ উচ্চ বিদ্যালয়,ঢাকা,বাংলাদেশ</h2>
            </div>
          </div>
        </div>
        <ResultInputForm classes={classes} session={sessions} />
      </div>
    </div>
  );
};
